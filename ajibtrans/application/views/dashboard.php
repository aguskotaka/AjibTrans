            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">AjibTrans mungkin menawarkan tarif yang bersahabat dan berbagai penawaran diskon
                ...
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="d-flex border-top">
                                        <small class="w-50 text-center border-end py-2">
                                            <a class="text-body" href="<?= base_url('home/artikel/'.$uu['slug']) ?>"><i class="fa fa-eye text-primary me-2"></i>View
                                                detail</a>
                                        </small>
                                        <small class="w-50 text-center py-2">
                                            <a class="text-body" href="https://wa.me/6282313007775?text=Halo, selamat siang, saya mau sewa mobil ini bisa? ...."><i class=""></i>
                                                <?= $uu['status'] ?>
                                            </a>
                                        </small>
                                    </div>
                        ...
                        <div class="col-12 text-center">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="<?= base_url('Home/produk/') ?>">Lihat Lebih Banyak</a>
                        </div>
