                            ...
                            <form action="<?= base_url('admin/auth/login') ?>" method="post">
                                <a href="index.html" class="app-brand-link gap-2">
                                    <a href="<?= base_url('admin/dashboard/index') ?>" class="text-nowrap logo-img">
                                        <img src="<?= base_url('assets/sneat') ?>/assets/img/favicon/logo.png"
                                            width="300" height="85" alt="" />
                                    </a>
                                    
                                </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang di AJIBTRANS</h4>
