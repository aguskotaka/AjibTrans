...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a class="navbar-brand" href="<?= base_url('admin/auth') ?>"><img src="<?= base_url('assets/trator/') ?>images/ajibfix.png"
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="">
                        <img class="img-fluid w-100" src="<?= base_url('assets/upload/barang/' . $barang->foto) ?>">
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row mb-4">
                            ...
                            <div class="col-6 col-sm-6">
                                <p><i class="fa fa-check text-primary me-3"></i>Pelayanan Dinas</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Liburan Keluarga</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Kondagan</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Antar jemput bandara</p>
                            </div>
                            <div class="col-6 col-sm-6">
                                <p><i class="fa fa-check text-primary me-3"></i>Luar kota / Dalam kota</p>
                                <p><i class="fa fa-check text-primary me-3"></i>City tour</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Piknik private</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Dll</p>
                            </div>
                        </div>
                        <a class="btn btn-primary py-3 px-5 mt-2" href="<?= base_url('home/produk') ?>">Kembali</a>
                    </div>
