...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2023 at 10:21 AM
...
(5, 'Avansa', 'Toyota Avanza adalah mobil berjenis kendaraan multi-guna (MPV) yang dikembangkan oleh Daihatsu dan dipasarkan oleh Toyota dan Daihatsu, utamanya dijual dengan layout kursi tiga baris. Generasi pertama mobil ini diluncurkan pada tanggal 11 Desember 2003 dan mulai diproduksi sejak Januari 2004.', '20231027181913.jpg', '250.000', 'Avansa', '3', '2023-10-27', 'Rippky', 'Ready'),
...
(18, 'Caraousel 1', '20231109214719.jpg');
...
(1, 'AjibTrans', 'Ajib Transport adalah jasa persewaan mobil terlengkap di Solo Raya yang memiliki ijin resmi, melayani perjalanan dalam dan luar kota. Armada lengkap, baru, berkualitas, nyaman serta bersih. Kami memiliki sdm driver A Class yang handal dan professional.', 'Buka setiap hari, 24 jam', 'https://instagram.com/ajibtrans', 'https://facebook.com/ajibtrans', 'ajibtrans@gmail.com', 'Krajan RT 01/04, Bulakrejo, Kabupaten Sukoharjo, Jawa Tengah', '082313007775', 'https://tiktok.com/@ajibtrans');
...
(1, 'Rifqii Ahmad Daanii', 'Rippky', '81dc9bdb52d04dc20036dbd8313ed055', 'Admin');
...
--
ALTER TABLE `caraousel`
  MODIFY `id_caraousel` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
